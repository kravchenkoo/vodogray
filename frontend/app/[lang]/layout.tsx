  ...
  return (
    <html lang="en">
      <body className={`${roboto.className} font-medium`}>
        <div className="grid grid-cols-[1fr] md:grid-cols-[26rem_1fr] grid-rows-[auto_1fr] h-dvh">
          <Sidebar lang={lang}></Sidebar>
          <Header lang={lang}></Header>
          <main className="md:p-[4rem_4.8rem_6.4rem] p-[4rem_1.8rem_6.4rem] relative bg-gray-50 overflow-y-scroll">
