...
import { HiOutlinePhone, HiOutlineHome, HiOutlineClipboardDocumentList } from 'react-icons/hi2'
      ...
      <ul className="flex flex-col gap-[0.8rem]">
        <li>
          <Link
            href={`/${lang}/`}
            className={`navLink ${
              lastUrlSegment[0] === '' || lastUrlSegment[0] === 'en' ? 'active' : ''
            }`}
          >
            <HiOutlineHome />
        ...
        <li>
          <Link
            href={`/${lang}/contacts`}
            className={`navLink ${lastUrlSegment[0] === 'contacts' ? 'active' : ''}`}
          >
            <HiOutlinePhone />
        ...
        <li>
          <Link
            href={`/${lang}/rules`}
            className={`navLink ${lastUrlSegment[0] === 'rules' ? 'active' : ''}`}
          >
